...
| Ley 7092 del Impuesto sobre la Renta (texto consolidado)  | Public               | HTML            | Added by [#268](https://github.com/rjwrld/tramitico/issues/268). [SINALEVI ficha 10969](https://sinalevi.go.cr/ResultadosNormativa/Informacion?param1=10969&param2=&param3=1&param4=) resolves to vigente version 83 (`idVersionNorma` 148972), with 153 chunks. It consolidates Ley 10818: artículo 8 inciso s) allows physical persons providing services to choose a single 25% deduction without proof; artículo 15 carries the 2026 activity-income scale and the salary-plus-activity rule. It sits beside `reglamento-renta` because the law owns the substantive obligation and the regulation its application. Replaces `ley-9635` completely: that amending law duplicated IVA, elided unchanged renta provisions, and added unrelated titles to retrieval. |
...
| Reglamento al Título IV de Ley 9635                       | Retired (#256)       | HTML            | Reglamento de la **regla fiscal** para gasto del Sector Público no Financiero, not renta or independent-worker tax: 0/47 audited chunks mentioned impuesto sobre la renta/utilidades and 27/47 said «regla fiscal». Removed wholesale; no eval target referenced it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| DGT resolution MH-DGT-RES-0017-2023                       | Retired (#256)       | HTML            | Enumerates port and vessel-attention services tied to goods exports. It does not govern professional-service exports; #111 had already removed it as an eval target, and #256 removed the document wholesale. The applicable audience sources remain Reglamento de Comprobantes art. 2 and Reglamento IVA art. 11.                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| Reglamento de Comprobantes Electrónicos (Decreto 44739-H) | Public               | SCIJ full text  | In force                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Disposiciones técnicas v4.4 (MH-DGT-RES-0027-2024)        | Public, excerpted    | HTML/spec       | Mandatory since 1 Sep 2025. #256 keeps the consolidated resolution's artículos 1–13 and Transitorios I–III, and excludes the implementation annexes (XML/schema samples, certificate/base64 payloads, signature examples and API/OAuth credential instructions).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| CCSS Base Mínima Contributiva                             | Public, excerpted    | SCIJ + CCSS     | [SCIJ decree](https://pgrweb.go.cr/scij/Busqueda/Normativa/Normas/nrm_texto_completo.aspx?param1=NRTC&nValor1=1&nValor2=87782&nValor3=114491&strTipM=TC). **Carries no rates** — the escala table is a raster image (#114). #256 keeps only Acuerdos Segundo–Cuarto for the SM-linked adjustment mechanism; Acuerdo Primero and its stale note (1), «1.24% Seguro de IVM», are excluded. Current rates come from the CCSS actas below.                                                                                                                                                                                                                                                                                                                                |
...
| CCSS Prescripción de deudas                               | Public               | HTML microsite  | Added by #260. [CCSS](https://www.ccss.sa.cr/web/prescripcion/) publishes the procedure that complements Ley 10.363: the 4/10-year rule, the exceptional 24-month window from 2023-05-08, where and how to submit the note, its required data, and the 20-business-day decision period for debts already in collection. Chunked by explanatory/FAQ heading.                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `ley-9635`          |    3 | the same 3 formulas, quoted inside this ficha; retired by #268            | **3 of 3** — but spent               |
...
**TRIBU-CR timeline:** TRIBU-CR launched **6 Oct 2025** at `ovitribucr.hacienda.go.cr` and became the exclusive filing system, with the legacy platforms disabled under [MH-DGT-RES-0011-2025 (SINALEVI ficha 104789)](https://sinalevi.go.cr/ResultadosNormativa/Informacion?param1=104789&param2=&param3=1&param4=). The earlier CP-39-2025 press release said the launch would be 4 Aug 2025; that announcement is retired from the corpus because the date did not hold. E-invoicing v4.4 has been mandatory since 1 Sep 2025.

**CCSS prescripción timeline:** Ley 10.363 took effect on 8 May 2023. The exceptional 24-month period for previously unregistered independent workers therefore ended on **8 May 2025**; the ordinary 10-year rule now applies to an unregistered worker who did not regularize within that period. The [CCSS procedure microsite](https://www.ccss.sa.cr/web/prescripcion/) remains the primary operational source for requesting prescription; unlike that closed exceptional window, it says there is no deadline for submitting an administrative prescription request.
...
measured on the vigente versions in August–September 2026:
