...
| `../../corpus/cabys-dev.json` | A hand-curated subset of CABYS codes relevant to software work: code, official description and IVA rate, copied from the public catalog | `https://www.bccr.fi.cr/indicadores-economicos/cat%C3%A1logo-de-bienes-y-servicios` | Official public catalog data (BCCR). The selection is ours; the codes and descriptions are not. Outside the Apache license. |
