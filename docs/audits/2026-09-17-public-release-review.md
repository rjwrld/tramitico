...
| The allowlist      | `.gitleaks.toml`, `regexTarget = "line"`, one regex on `doc_?key` assignments                                                                       | Matches the name, not the value: a real secret assigned to any other name still fires.                                                                                    |
